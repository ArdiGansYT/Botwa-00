...
const vcard = 'BEGIN:VCARD\n' //GANTI NO DAN NAMA DIBAWAH INI JADI PUNYA LU
            ...
            + 'FN: ArdiGans Official\n' //PENGEMBANG BY :
            + 'ORG: PatrickBot Offick;\n' //MYBOT TEAM
            + 'TEL;type=CELL;type=VOICE;waid=6285282996146:+62 882-2160-8614\n' 
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6285282996146@s.whatsapp.net","6283102650464@s.whatsapp.net"]
/************************************/
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('Sqan Tuh Asu. Work kan','white'),color('Ardi','red'),color('Gans','white'),color('YTOfficial','yellow'))
})
